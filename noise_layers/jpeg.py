...
class JpegMask(JpegBasic):
	...
	# 	self.postprocess(self.real_H),  # ground truth original image
	# 	self.postprocess(masks),  # groung truth canny edge
	# 	self.postprocess(forward_image),
	# 	self.postprocess(5 * torch.abs(self.real_H - forward_image)),  # groung truth canny edge
	# 	self.postprocess(attacked_image),
	# 	self.postprocess(5 * torch.abs(forward_image - attacked_image)),  # groung truth canny edge
	# 	self.postprocess(tampered_attacked_image),  # immunized image
	# 	self.postprocess(reversed_image),  # residual augmented
	# 	self.postprocess(5 * torch.abs(self.real_H - reversed_image)),  # groung truth canny edge
	# 	# self.postprocess(immunized_images),  # rectified image
	# 	# self.postprocess(broken_immunized_images),  # rectified image （from attack network）
	# 	# self.postprocess(edges_real),  # predicted edge
	# 	# self.postprocess(extracted),  # recovered image 1
	# 	# self.postprocess(recover_real),  # recovered image 1
	# 	# self.postprocess(output_direct_access_ideal),  # recovered image 2
	# 	# self.postprocess(output_direct_access),    # recovered image 2
	# 	# self.postprocess(result_image),  # recovered image merged
	# 	# self.postprocess(predicted_masks),  # recovered image merged
	# 	img_per_row=1
	# )
