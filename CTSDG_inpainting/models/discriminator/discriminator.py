...
from CTSDG_inpainting.models.discriminator.structure_branch import EdgeDetector, StructureBranch
from CTSDG_inpainting.models.discriminator.texture_branch import TextureBranch
