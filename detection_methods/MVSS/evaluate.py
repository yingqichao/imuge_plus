...
def parse_args():
    ...
    parser.add_argument('--gt_file', type=str, default='gt_file')
    parser.add_argument('--th', type=float, default=0.5)
    parser.add_argument("--model_name", type=str, help="Path to the pretrained model", default="ckpt/mvssnet_casia.pt")
