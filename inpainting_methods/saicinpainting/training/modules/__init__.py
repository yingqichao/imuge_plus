...
from inpainting_methods.saicinpainting.training.modules.ffc import FFCResNetGenerator
from inpainting_methods.saicinpainting.training.modules.pix2pixhd import GlobalGenerator, MultiDilatedGlobalGenerator, \
