...
# CVPR
CUDA_VISIBLE_DEVICES=0,1,2 python -m torch.distributed.launch --master_port 27766 --nproc_per_node=3 train.py -opt options/train/train_IRNclr_x4.yml -mode 0 --launcher pytorch
...
# PAMI
#CUDA_VISIBLE_DEVICES=4 python -m torch.distributed.launch --master_port 3111 --nproc_per_node=1 train.py -opt options/train/train_IRN+_x4.yml -mode 0 --launcher pytorch
