...
class SRMNet(nn.Module):
    def __init__(self, in_chn=3,out_chn=3, wf=96, depth=4):
        ...
        # self.BayarConv2D = nn.Conv2d(in_chn, 3, 5, 1, padding=0, bias=False)
    ...
    def forward(self, x):
        ...
        ##### Reconstruct #####
        out_1 = torch.sigmoid(self.last(msff_result))
